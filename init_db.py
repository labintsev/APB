...
regions_data = [
    ...
    {"id": 20, "name": "Чувашская Республика"},
    ...
    {"id": 80, "name": "Ненецкий автономный округ"},
    {"id": 81, "name": "Ханты‑Мансийский автономный округ — Югра"},
    {"id": 82, "name": "Чукотский автономный округ"},
    {"id": 83, "name": "Ямало‑Ненецкий автономный округ"},
    {"id": 84, "name": "Республика Крым"},
    {"id": 85, "name": "Город Севастополь"},
    {"id": 86, "name": "Автономная Республика Крым"}
]
